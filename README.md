...
- **AI Brain:** OpenAI API (Direct Integration)
- **Database & Auth:** Firebase Auth & Firestore (Real-time syncing)
- **Security:** Custom Rate Limiting & Token Budgeting per IP/UID
...
- **Otak AI:** OpenAI API (Direct Integration, tanpa Genkit)
- **Database & Keamanan:** Firebase Auth & Firestore (Sinkronisasi *Real-time*)
- **Security:** Rate Limiting (Pencegahan Spam) & Token Budgeting (Sistem Kuota IP/UID)
